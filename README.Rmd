...
> Jobst, D., Möller, A., and Groß, J. 2024. Time Series based Ensemble Model Output Statistics for Temperature Forecasts Postprocessing. (preprint version available at https://arxiv.org/abs/2402.00555)
...
For the data license see [here](https://github.com/jobstdavid/paper_tsEMOS/DATA_LICENSE).
...
- Meteoro\text{log}ical variable: [2m surface temperature](https://codes.ecmwf.int/grib/param-db/?id=167) (t2m)
...
- [ensAR](https://github.com/JuGross/ensAR): Local autoregressive adjusted EMOS (AR-EMOS) with rolling training period.
...
- [imputeTS](https://cran.r-project.org/web/packages/imputeTS/index.html): For the missing value imputation.
